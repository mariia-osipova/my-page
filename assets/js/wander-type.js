(function () {
  ...
  const text = ((host && host.querySelector('.wander-sr') && host.querySelector('.wander-sr').textContent) || "Hi! I'm Mariia.").trim();
  ...
  const SK = {
    ...
    "'": [[[0.52, 0], [0.42, 0.26]]],
    '0': [[[0.22, 0.14], [0.5, 0.03], [0.8, 0.14], [0.92, 0.5], [0.8, 0.88], [0.5, 0.99], [0.2, 0.88], [0.08, 0.5], [0.22, 0.14]]],
    '4': [[[0.76, 0], [0.18, 0.68]], [[0.76, 0], [0.76, 1]], [[0.14, 0.68], [0.88, 0.68]]],
  };
